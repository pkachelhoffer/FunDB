...
{
    internal abstract class FDIndexOld<TTableDefinition>
    {
    ...
    internal class FDIndexOld<TTableDefinition, TIndexDefinition> : FDIndexOld<TTableDefinition>
        where TIndexDefinition : class, IComparable, new()
    {
        ...
        private byte[] IndexBytes { get; set; }

        internal FDIndexOld(Func<TTableDefinition, TIndexDefinition> funcGenerateIndex, string tablePath, string tableName, string indexName)
        {
